...
export default function Hero({ block }: HeroProps) {
  return (
    <main className="container flex flex-col text-center justify-center gap-3">
      <section className="md:w-8">
        <h2 className="text-base font-bold">{block.caption}</h2>
        <h1 className="text-5xl md:text-7xl text-balance font-bold tracking-tighter justify-center">
          {block.heading}
        </h1>
      </section>
